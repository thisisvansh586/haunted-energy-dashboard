-- ============================================================================
-- COMPLETE SETUP - Haunted Energy Dashboard Phase 2
...
CREATE INDEX idx_telemetry_home_created ON telemetry(home_id, created_at DESC);
...
CREATE INDEX idx_anomalies_home_created ON anomalies(home_id, created_at DESC);
...
-- Now restart your servers and refresh the browser!
